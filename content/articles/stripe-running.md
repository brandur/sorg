...
{{Figure "The daunting Triple Peaks run in San Francisco." (ImgSrcAndAltAndClass "/assets/images/stripe-running/triple-peaks.png" "The daunting Triple Peaks run in San Francisco." "overflowing")}}
