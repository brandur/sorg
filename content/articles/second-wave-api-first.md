...
### Ubiquitous again (#ubiquitous-again)
...
[Slack's rate limits](https://docs.slack.dev/ai/slack-mcp-server/#rate-limits) are a good example of this, supporting numbers like 50 channel or 100 profile reads per minute. You can't build a multi-user app with 50 channel reads per minute, but it's plenty for a single user to access their own account.
