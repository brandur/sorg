...
{{Figure "Transactions blocking during a table rewrite." (ImgSrcAndAltAndClass "/assets/images/postgres-default/blocking.svg" "Transactions blocking during a table rewrite." "overflowing")}}
...
{{Figure "Fast column creation with existing rows loading defaults from pg_attribute." (ImgSrcAndAltAndClass "/assets/images/postgres-default/implementation.svg" "Fast column creation with existing rows loading defaults from pg_attribute." "overflowing")}}
