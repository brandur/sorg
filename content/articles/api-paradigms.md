...
{{Figure "GraphQL produces an API that can be queried in complex ways." (ImgSrcAndAltAndClass "/assets/images/api-paradigms/graphql.jpg" "GraphQL produces an API that can be queried in complex ways." "overflowing")}}
...
{{Figure "By dropping a resource-based world view, we can better map endpoints to the user actions." (ImgSrcAndAltAndClass "/assets/images/api-paradigms/rpc-vs-rest.svg" "By dropping a resource-based world view, we can better map endpoints to the user actions." "overflowing")}}
...
{{Figure "Some tooling to help create a bespoke leather product." (ImgSrcAndAltAndClass "/assets/images/api-paradigms/bespoke.jpg" "Some tooling to help create a bespoke leather product." "overflowing")}}
