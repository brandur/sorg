...
{{Figure "The relationships between people in a town are a graph. This is a stretch (but I like this photo)." (NewImgSrcAndAlt "/assets/images/graphql/village.jpg" "The relationships between people in a town are a graph. This is a stretch (but I like this photo).")}}
...
{{Figure "Using GraphiQL to explore an API and graph." (NewImgSrcAndAlt "/assets/images/graphql/graphiql.png" "Using GraphiQL to explore an API and graph.")}}
...
{{Figure "In the ideal case, we produce APIs that grow and improve like living things. My hands were really cold when I shot this." (NewImgSrcAndAlt "/assets/images/graphql/living.jpg" "In the ideal case, we produce APIs that grow and improve like living things. My hands were really cold when I shot this.")}}
