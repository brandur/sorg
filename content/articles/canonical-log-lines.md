...
{{Figure "The tiers of observability, showing the trade-off between query flexibility and ease of reference." (ImgSrcAndAlt "/assets/images/canonical-log-lines/observability-tiers.svg" "The tiers of observability, showing the trade-off between query flexibility and ease of reference.")}}
...
{{Figure "Canonical log lines being emitted (and ingested) for each request." (ImgSrcAndAlt "/assets/images/canonical-log-lines/canonical-log-lines.svg" "Canonical log lines being emitted (and ingested) for each request.")}}
...
{{Figure "What a canonical log line looks like in raw form as it's being emitted." (ImgSrcAndAlt "/assets/images/canonical-log-lines/example-line.svg" "What a canonical log line looks like in raw form as it's being emitted.")}}
...
{{Figure "Error counts for the last week on the \"list events\" endpoint." (ImgSrcAndAlt "/assets/images/canonical-log-lines/error-timechart.png" "Error counts for the last week on the \"list events\" endpoint.")}}
...
{{Figure "The names of the Ruby exception classes emitted for each error, and their relative count." (ImgSrcAndAlt "/assets/images/canonical-log-lines/top-errors.png" "The names of the Ruby exception classes emitted for each error, and their relative count.")}}
...
{{Figure "An inverted search. API versions pulled from the canonical log line and fetched by class of error." (ImgSrcAndAlt "/assets/images/canonical-log-lines/top-api-versions.png" "An inverted search. API versions pulled from the canonical log line and fetched by class of error.")}}
...
{{Figure "Splunk dashboard for requests from a user by TLS version." (ImgSrcAndAlt "/assets/images/canonical-log-lines/tls-requests-by-merchant.png" "Splunk dashboard for requests from a user by TLS version.")}}
