...
{{Figure "The anatomy of inet and cidr values." (ImgSrcAndAlt "/assets/images/sortsupport-inet/inet-cidr-anatomy.svg" "The anatomy of inet and cidr values.")}}
...
{{Figure "One bit reserved for IP family." (ImgSrcAndAlt "/assets/images/sortsupport-inet/ip-family.svg" "One bit reserved for IP family.")}}
...
{{Figure "Number of bits available to store network per datum size and IP family." (ImgSrcAndAlt "/assets/images/sortsupport-inet/network-bits.svg" "Number of bits available to store network per datum size and IP family.")}}
...
{{Figure "The design of abbreviated keys for inet and cidr." (ImgSrcAndAlt "/assets/images/sortsupport-inet/key-design.svg" "The design of abbreviated keys for inet and cidr.")}}
