...
{{Figure "A visualization of the \"leaky bucket\" analog, where water is symbolic of rate-limited actions." (ImgSrcAndAlt "/assets/images/rate-limiting/leaky-bucket.svg" "A visualization of the \"leaky bucket\" analog, where water is symbolic of rate-limited actions.")}}
...
{{Figure "A visualization of an allowed request under GCRA. A request at time t0 is successful." (ImgSrcAndAlt "/assets/images/rate-limiting/allowed-request.svg" "A visualization of an allowed request under GCRA. A request at time t0 is successful.")}}

For a failed request, the time of the next allowed request is in the future,
prompting us to deny the request:

{{Figure "A visualization of a denied request under GCRA. A request at time t0 is rejected." (ImgSrcAndAlt "/assets/images/rate-limiting/denied-request.svg" "A visualization of a denied request under GCRA. A request at time t0 is rejected.")}}
