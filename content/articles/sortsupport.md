...
!fig src="/assets/images/sortsupport/sort-tuples.svg" caption="An array of sort tuples."
...
!fig src="/assets/images/sortsupport/abbreviated-keys.svg" caption="A sort tuple with an abbreviated key and pointer to the heap."
...
!fig src="/assets/images/sortsupport/uuid.svg" caption="Abbreviated key formats for the `uuid` type."
...
!fig src="/assets/images/sortsupport/endianness.svg" caption="Example placement of integer bytes on little and big endian architectures."
