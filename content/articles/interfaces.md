...
{{Figure "Will Cmd + Tab be the next victim of overzealous animation?" (ImgSrcAndAlt "/assets/images/interfaces/cmd-tab.png" "Will Cmd + Tab be the next victim of overzealous animation?")}}
