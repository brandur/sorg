...
{{Figure "Child processes transitioning from mostly shared memory to mostly copied as they mature." (NewImgSrcAndAlt "/assets/images/ruby-memory/child-processes.svg" "Child processes transitioning from mostly shared memory to mostly copied as they mature.")}}
...
{{Figure "A heap, its heap pages, and slots within each page." (NewImgSrcAndAlt "/assets/images/ruby-memory/heap-slots.svg" "A heap, its heap pages, and slots within each page.")}}
...
{{Figure "A heap's freelist pointer to a free RVALUE, and the continuing linked list." (NewImgSrcAndAlt "/assets/images/ruby-memory/freelist.svg" "A heap's freelist pointer to a free RVALUE, and the continuing linked list.")}}
...
{{Figure "A fragmented heap before and after GC compaction." (NewImgSrcAndAlt "/assets/images/ruby-memory/compaction.svg" "A fragmented heap before and after GC compaction.")}}
