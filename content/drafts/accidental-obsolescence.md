...
{{Figure "A signature feature of iOS 11: a customizable (and more useful) Control Center." (ImgSrcAndAltAndClass "/assets/images/accidental-obsolescence/ios11.png" "A signature feature of iOS 11: a customizable (and more useful) Control Center." "overflowing")}}
...
{{Figure "Adequate performance seems destined to be lost to time." (ImgSrcAndAltAndClass "/assets/images/accidental-obsolescence/ruins.jpg" "Adequate performance seems destined to be lost to time." "overflowing")}}
...
{{Figure "A SNES cartridge. Software that once shipped, was set in stone." (ImgSrcAndAltAndClass "/assets/images/accidental-obsolescence/cartridge.jpg" "A SNES cartridge. Software that once shipped, was set in stone." "overflowing")}}
