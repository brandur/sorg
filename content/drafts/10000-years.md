...
instead of four -- to them, it's now the year 02018.
...
_A screenshot of that tweet goes here._
...
* Relatedly, Go is a **statically typed language** which
  ...
  problems only appear at runtime). I've also written a
...
* Relatedly, changes in **Twitter's product** might also
  ...
  model, remodel their product's core architecture, or fold
  as a company.
...
edges over the years. It stands to reason that they'll
eventually undertake a project to revitalize it, and that
will likely spell the end of the current API after a
...
### The principles rethought for software (#software)
