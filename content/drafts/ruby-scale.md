...
{{Figure "Without constraints, code becomes a tight knot as modules bleed into each other." (ImgSrcAndAlt "/assets/images/ruby-scale/knot.jpg" "Without constraints, code becomes a tight knot as modules bleed into each other.")}}
...
{{Figure "Boundary violations grow linearly with the number of lines of Ruby produced." (ImgSrcAndAlt "/assets/images/ruby-scale/modularity.svg" "Boundary violations grow linearly with the number of lines of Ruby produced.")}}
...
{{Figure "Good tooling is sadly lacking/impossible." (ImgSrcAndAlt "/assets/images/ruby-scale/tooling.jpg" "Good tooling is sadly lacking/impossible.")}}
