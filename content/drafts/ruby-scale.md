...
{{Figure "Without constraints, code becomes a tight knot as modules bleed into each other." (ImgSrcAndAltAndClass "/assets/images/ruby-scale/knot.jpg" "Without constraints, code becomes a tight knot as modules bleed into each other." "overflowing")}}
...
{{Figure "Boundary violations grow linearly with the number of lines of Ruby produced." (ImgSrcAndAltAndClass "/assets/images/ruby-scale/modularity.svg" "Boundary violations grow linearly with the number of lines of Ruby produced." "overflowing")}}
...
{{Figure "Good tooling is sadly lacking/impossible." (ImgSrcAndAltAndClass "/assets/images/ruby-scale/tooling.jpg" "Good tooling is sadly lacking/impossible." "overflowing")}}
