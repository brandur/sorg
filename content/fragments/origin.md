...
{{Figure "Submitting a form from a static site to a dynamic signup app." (ImgSrcAndAltAndClass "/assets/images/fragments/origin/submit.svg" "Submitting a form from a static site to a dynamic signup app." "overflowing")}}
